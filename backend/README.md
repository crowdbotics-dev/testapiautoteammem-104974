...
## Project Structure
    ...
    ├── testapiautoteammem_104974  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_104974`
...
2. Clone this repo and `cd testapiautoteammem_104974`
